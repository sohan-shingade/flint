...
|---|---|---|---|---|---|
| D-2.1.b | 🟡 | 2w | claude | 2026-04-24 | Steps 1–6 of 7 shipped: `PositionManager` + `CashManager` + `FillRecorder` + `OrderQueue` + `FundingLedger` + `BorrowLedger` extracted; BacktestContext composes all six via property aliases or direct delegation · Step 7 (Risk surface) remains |
