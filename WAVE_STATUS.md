...
|---|---|---|---|---|---|
| D-2.1.b | 🟡 | 2w | claude | 2026-04-24 | Steps 1–5 of 7 shipped: `PositionManager` + `CashManager` + `FillRecorder` + `OrderQueue` + `FundingLedger` extracted; BacktestContext composes all five via property aliases or direct delegation · Steps 6–7 (BorrowLedger, Risk surface) remain |
