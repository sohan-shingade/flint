...
|---|---|---|---|---|---|
| D-2.1.b | 🟡 | 2w | claude | 2026-04-24 | Steps 1–3 of 7 shipped: `PositionManager` + `CashManager` + `FillRecorder` extracted, BacktestContext composes all three via property aliases · Steps 4–7 (OrderQueue, FundingLedger, BorrowLedger, Risk surface) remain |
