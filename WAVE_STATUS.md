...
|---|---|---|---|---|---|
| D-2.1.b | 🟡 | 2w | claude | 2026-04-24 | Steps 1–4 of 7 shipped: `PositionManager` + `CashManager` + `FillRecorder` + `OrderQueue` extracted, BacktestContext composes all four via property aliases · Steps 5–7 (FundingLedger, BorrowLedger, Risk surface) remain |
